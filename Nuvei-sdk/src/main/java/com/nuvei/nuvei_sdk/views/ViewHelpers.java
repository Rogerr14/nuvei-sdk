...
import static com.nuvei.nuvei_sdk.models.CardModel.CVC_LENGTH_AMERICAN_EXPRESS;
import static com.nuvei.nuvei_sdk.models.CardModel.CVC_LENGTH_COMMON;
...
public class ViewHelpers {
    ...
    static boolean isCvcMaximalLength(
            @NonNull @CardModel.CardBrand String cardBrand,
            @Nullable String cvcText) {
        if (cvcText == null) {
            return false;
        }

        if (CardModel.AMERICAN_EXPRESS.equals(cardBrand)) {
     ...
     * @param brand               the {@link CardModel.CardBrand} to use as a separating scheme
    ...
    public static String[] separateCardNumberGroups(@NonNull String spacelessCardNumber,
                                                    @NonNull @CardModel.CardBrand String brand) {
        String[] numberGroups;
        if (brand.equals(CardModel.AMERICAN_EXPRESS)) {
